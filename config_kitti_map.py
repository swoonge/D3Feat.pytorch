...
net_arg.add_argument('--batch_norm_momentum', type=float, default=0.96)
...
loss_arg.add_argument('--safe_radius', type=float, default=1.5)
...
opt_arg.add_argument('--scheduler_gamma', type=float, default=0.001**(1/150)) ##
...
data_arg.add_argument('--data_ver', type=str, default='ver2')
