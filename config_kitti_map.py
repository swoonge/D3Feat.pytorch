...
experiment_id = "kitti" + time.strftime('%m%d%H%M')
...
net_arg.add_argument('--deform_radius', type=float, default=10.0)
...
net_arg.add_argument('--batch_norm_momentum', type=float, default=0.95)
...
loss_arg.add_argument('--safe_radius', type=float, default=1.0)
...
opt_arg.add_argument('--max_epoch', type=int, default=500)
...
opt_arg.add_argument('--weight_decay', type=float, default=0.0001)
...
data_arg.add_argument('--augment_translation', type=float, default=0.3, help='translation = num (m)')
...
experiment_id = "kitti_map_" + time.strftime('%m/%d/%H') + "_ds03"
# snapshot configurations
snapshot_arg = add_argument_group('Snapshot')
snapshot_arg.add_argument('--snapshot_dir', type=str, default=f'./data/kitti_map/snapshot/{experiment_id}')
snapshot_arg.add_argument('--tboard_dir', type=str, default=f'./data/kitti_map/tensorboard/{experiment_id}')
